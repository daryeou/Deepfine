...
import com.wonjo.deepfine.ui.atomic.VerticalSpacer
...
fun BasicTextField(
    ...
    clearIconContentDescription: String? = "입력 내용 지우기",
    ...
    val fieldTextStyle = AppTextStyles.TextFieldInput.copy(
        color = if (enabled) Colors.Black else Colors.GrayM,
    )
    ...
    Column(modifier = modifier) {
        ...
        ComposeBasicTextField(
            ...
            cursorBrush = SolidColor(cursorColor ?: inputStatus.themeColor),
            decorationBox = { innerTextField ->
                Column {
                    Row(
                        ...
                        if (enabled && text.isNotEmpty() && onClear != null) {
                            ClearButton(
